...
| 操作 | 输入 | 原文件名 | 新文件名 |
|------|------|---------|---------|
| 添加前缀 | `笔记_` | `文档.pdf` | `笔记_文档.pdf` |
| 添加后缀 | `_v2` | `文档.pdf` | `文档_v2.pdf` |
| 删除前N个 | `3` | `ABCDE.pdf` | `DE.pdf` |
| 删除后N个 | `3` | `ABCDE.pdf` | `AB.pdf` |
| 替换前N个 | 3→`XX` | `ABCDE.pdf` | `XXDE.pdf` |
| 替换后N个 | 3→`XX` | `ABCDE.pdf` | `ABXX.pdf` |
